...
//</td><td><button id="delete"class="button" onclick="deleteAction();">삭제</button></td></tr>
	...
	function printList(result){
		...
		var $body = $("#list");
		//var blockButton = ;
		$.each(result.sell, function(idx, sell) {
			...
			$("<button>").attr("class","block").attr("id","button"+idx).val("test").text($("#changeState"+idx).val()).attr("class","button").appendTo($tr);
...
<div>
	...
	<div style="text-align: left">
		<div style="text-align: left;" class="inline">
			<span>판매글</span>
			<button id="hideCheck"class="button">체크 숨기기</button>
			<button id="deleteCheck"class="button">체크 삭제</button> 	
		</div>
		<div class="inline" id="icons">
