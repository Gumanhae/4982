...
public class ProductListDao {
	...
	public int findCountByTag(String tag) {
		return tpl.selectOne("productListMapper.findCountByTag",tag);
	}
	...
	public List<Sell> findPageByTag(int startRowNum, int endRowNum, String pname) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("startRowNum", startRowNum);
		map.put("endRowNum", endRowNum);
		map.put("pname",pname);
		return tpl.selectList("productListMapper.findPageByTag", map);
	}
}
