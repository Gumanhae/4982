...
public class MemberDao {
	...
	public String checkId(String username) {
		return tpl.selectOne("memberMapper.checkId", username);
	}
	public String checkEmail(String email) {
		return tpl.selectOne("memberMapper.checkEmail", email);
	}
	...
	public int changeSajin(String fileUrl, String username) {
		Map<String,String> map = new HashMap<String, String>();
		map.put("username", username);
		map.put("sajin", fileUrl);
		return tpl.update("memberMapper.changeSajin", map);
	}

	public String findProfilByUsername(String username) {
		return tpl.selectOne("memberMapper.findProfilByUsername", username);
	}
