...
public class SellDao {
	...
	public int findCount() {
		return tpl.selectOne("sellMapper.findCount");
	}
	public List<Sell> findAllSalesArticeList(int startRowNum, int endRowNum) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("startRowNum", startRowNum);
		map.put("endRowNum", endRowNum);
		return tpl.selectList("sellMapper.findAllList", map);
	}
